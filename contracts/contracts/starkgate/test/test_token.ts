...
describe('ContractTests', function () {
  ...
  before(async () => {
    ...
    ERC20Contract = await ERC20Factory.deploy({
      ...
      symbol: SYMBOL,
      decimals: DECIMALS,
      minter_address: accountMinter.starknetContract.address,
    })
  ...
  it('Test increase and decrease Alllowance', async () => {
    ...
    await accountUser2.invoke(ERC20Contract, 'decreaseAllowance', {
      spender: accountMinter.starknetContract.address,
      subtracted_value: { low: 10n, high: 0n },
    })
