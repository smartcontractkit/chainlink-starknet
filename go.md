...
flowchart LR
	...
	class chainlink-protos-repo outline
```
## All modules
```mermaid
flowchart LR
	...
	classDef outline stroke-dasharray:6,fill:none;
	class chainlink-repo,chainlink-ccip-repo,chainlink-common-repo,chainlink-framework-repo,chainlink-protos-repo,chainlink-starknet-repo,chainlink-testing-framework-repo,tdh2-repo outline
```
