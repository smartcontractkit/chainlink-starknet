...
if [[ $cpu_struct == *"arm"* ]]; then
	...
	container_version="${CONTAINER_VERSION:-d7c168ac53da3e9d717ed3ff8dad665ccade43e0}-arm"
else
	echo "Starting i386 devnet container..."
	container_version="${CONTAINER_VERSION:-d7c168ac53da3e9d717ed3ff8dad665ccade43e0}"
fi
