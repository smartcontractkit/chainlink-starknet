...
type NonceManager interface {
	...
	NextSequence(address *felt.Felt, chainID string) (*big.Int, error)
	IncrementNextSequence(address *felt.Felt, chainID string, currentNonce *big.Int) error
}
...
func (nm *nonceManager) NextSequence(addr *felt.Felt, chainId string) (*big.Int, error) {
...
func (nm *nonceManager) IncrementNextSequence(addr *felt.Felt, chainId string, currentNonce *big.Int) error {
	if err := nm.validate(addr, chainId); err != nil {
		return err
	}
