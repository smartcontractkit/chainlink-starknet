...
const commandConfig: EVMExecuteCommandConfig<UserInput, ContractInput> = {
  ...
  action: 'set_max_deposit',
  internalFunction: 'setMaxDeposit',
  ux: {
    description: 'Sets Max Deposit amount for the L1 Bridge',
    examples: [
      `${CATEGORIES.L1_BRIDGE}:set_max_deposit --network=<NETWORK> --amount=[AMOUNT_IN_LINK] [L1_BRIDGE_PROXY_ADDRESS]`,
    ],
  },
  makeUserInput,
  makeContractInput,
