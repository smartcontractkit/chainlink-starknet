...
mod SequencerUptimeFeed {
    ...
    use aggregator_consumer::libraries::access_control::{AccessControlComponent, IAccessController};
    use aggregator_consumer::libraries::access_control::AccessControlComponent::InternalTrait as AccessControlInternalTrait;
    ...
    impl Internals of InternalTrait {
        ...
        fn _update_round(ref self: ContractState, round_id: u128, mut round: Transmission) {
            round.transmission_timestamp = starknet::get_block_timestamp();
            self._round_transmissions.write(round_id, round);
