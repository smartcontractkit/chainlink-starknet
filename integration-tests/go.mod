...
require (
	...
	github.com/smartcontractkit/chainlink-starknet/ops v0.0.0-20220818193333-666574ae910e
	github.com/smartcontractkit/chainlink-testing-framework v1.5.3
)

require github.com/dontpanicdao/caigo v0.3.0 // indirect

require github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20220801192413-1edc37b124e3
