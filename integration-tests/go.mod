...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20260407130455-5258160d170f
...
replace (
	...
	// Patch starkkey for starknet.go v0.17 until chainlink-common/keystore is updated upstream.
	github.com/smartcontractkit/chainlink-common/keystore => ../ops/third_party/chainlink-common-keystore
	...
	github.com/smartcontractkit/gauntlet-plus-plus/sdks/go-gauntlet => ../ops/third_party/go-gauntlet
)
