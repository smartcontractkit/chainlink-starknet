...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20230602035856-3fe6454806c7
	github.com/smartcontractkit/chainlink/v2 v2.2.0-mercury-20230601.0.20230602035856-3fe6454806c7
)
