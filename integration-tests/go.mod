...
require (
	...
	github.com/smartcontractkit/chainlink-starknet/ops v0.0.0-20220929160142-83f3bd710afa
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.0-20220923221140-2cf0e5cbd55e
